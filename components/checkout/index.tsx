    ...
    <div className="container mx-auto md:h-screen">
      <div className="flex flex-col md:flex-row h-full">
        <div className="w-full md:w-3/5 p-10">
          <div className="text-5xl text-blue" style={{
            fontFamily: 'NewYork'
          ...
          <div className="flex flex-col space-y-3 mb-5">
            ...
            <h1 className="text-md font-bold font-newyork pt-6 text-blue text-xl"> Address </h1>
            <div className="w-full flex space-x-2">
              <div className="w-1/2">
                <label
                  className="block tracking-wide text-blue font-newyork text-md mb-3 font-bold"
        ...
        <div className="text-center font-newyork text-yellow text-3xl font-bold" >DRIP Inventory</div>
